...
const ModalMoreTrip: React.FC<Props> = ({ isOpen, onClose, trip }) => {
                                    ...
                                    <div className="relative bg-gray-100 rounded-xl overflow-hidden" style={{ height: '400px' }}>
                                        ...
                                        {routeData && (
                                            <>
                                                ...
                                                <div className="absolute bottom-4 right-4 bg-blue-500 text-white px-2 py-1 rounded text-xs font-bold">
                                                    B - Destination
                                                </div>
                                            </>
                                        )}
