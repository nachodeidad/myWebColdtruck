      ...
      >
        ...
        >
          <button
            ...
            onClick={onClose}
            className="absolute top-4 right-4 rounded-lg p-2 text-slate-500 transition-colors bg-slate-100 hover:bg-slate-200 hover:text-slate-700"
          >
            <X className="h-5 w-5" />
          </button>
          <div className="rounded-t-2xl bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            <h2 className="text-2xl font-bold text-white">Register New Truck</h2>
            <p className="mt-1 text-blue-100">Add a new truck to your fleet</p>
          </div>
