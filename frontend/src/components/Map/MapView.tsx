...
const MapView: React.FC<MapViewProps> = ({ origin, destination, path }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-4 left-4 z-[1000] bg-white px-3 py-2 rounded-lg shadow-lg text-sm">
      ...
      <div className="absolute top-4 right-4 z-[1000] bg-white px-3 py-2 rounded-lg shadow-lg text-sm">
        <div className="flex items-center gap-2">
