    ...
    <div id='Home' className="min-h-screen bg-white relative z-0 scroll-smooth">
        ...
        <main>
            ...
            <section className='p-5 lg:p-24 z-10' id='ContactUs'>
                ...
                <div className='grid lg:grid-cols-5 gap-5 z-10'>
                    <div className='shadow-xl rounded-lg p-8'>
                        ...
                        <div className='flex justify-center items-center'>
                            <p className='text-gray-500 z-10'>Full Stack Developer</p>
                        </div>
                        <div className='flex justify-center items-center  bg-blue-200 p-2 rounded-lg mt-2'>
                            <p className='text-center z-10'>Especialista en React, Node.js y arquitecturas de microservicios. Líder técnico del proyecto.</p>
                        </div>
                    ...
                    <div className='shadow-xl rounded-lg p-8'>
                        ...
                        <div className='flex justify-center items-center  bg-green-200 p-2 rounded-lg mt-2'>
                            <p className='text-center z-10'>Expert in IoT sensors, device communication, and telemetry protocols for refrigerated trailers.</p>
                        </div>
                        <div className='flex justify-center items-center mt-4'>
                            <Github className='mr-3'/>
                            <Mail className='ml-3'/>
                    ...
                    <div className='shadow-xl rounded-lg p-8'>
                        ...
                        <div className='flex justify-center items-center'>
                            <p className='text-gray-500 text-center z-10'>Scrum Master and Backend Developer</p>
                        </div>
                        <div className='flex justify-center items-center bg-violet-200 p-2 rounded-lg mt-2'>
                            <p className='text-center z-10'>Technical project leader. Specialist in databases, REST APIs, and real-time systems. Backend infrastructure architect.</p>
                        </div>
                        <div className='flex justify-center items-center mt-4'>
                            <Github className='mr-3'/>
                            <Mail className='ml-3'/>
                    ...
                    <div className='shadow-xl rounded-lg p-8'>
                        ...
                        <div className='flex justify-center items-center'>
                            <p className='text-gray-500 z-10'>Frontend Developer</p>
                        </div>
                        <div className='flex justify-center items-center bg-orange-200 p-2 rounded-lg mt-2'>
                            <p className='text-center z-10'>Expert in UX/UI and front-end development with React and TypeScript. Responsible for user experience.</p>
                        </div>
                        <div className='flex justify-center items-center mt-4'>
                    ...
                    <div className='shadow-xl rounded-lg p-8'>
                        ...
                        <div className='flex justify-center items-center mt-2'>
                            <p className='text-lg font-semibold z-10'>Morales Anacleto Mario Yair</p>
                        </div>
                        <div className='flex justify-center items-center'>
                        ...
                        <div className='flex justify-center items-center bg-red-200 p-2 rounded-lg mt-2'>
                            <p className='text-center z-10'>Mobile app development specialist, using React Native with Expo Go.</p>
                        </div>
                        <div className='flex justify-center items-center mt-4'>
                            <Github className='mr-6 z-10'/>
                            <Mail className='z-10'/>
                        </div>
                    </div>
                </div>
        ...
        <footer className="flex justify-center items-center p-24 w-full bg-[#0f172a] relative mt-10">
            <div
                className="absolute inset-0"
                style={{
                backgroundImage: `radial-gradient(circle 600px at 50% 50%, rgba(59,130,246,0.3), transparent)`,
